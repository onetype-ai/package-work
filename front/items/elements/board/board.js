	...
	elements.ItemAdd({
		...
		render: function()
		{
			...
			this.items = [
				...
				{ id: 3, priority: 'Urgent', title: 'Kanban drag and drop', description: 'Cards move between columns and persist the new status.', status: 'Working', author: { name: 'Dejan Tomić' }, date: 'Jul 18' },
			...
			return /* html */ `
				<e-views-board ot-if="columns().length" :field="'status'" :columns="columns()" :items="cards()" :background="2" :_open="open()" :_create="create()"></e-views-board>
